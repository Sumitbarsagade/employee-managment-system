import { Button, Input,RadioGroup, Radio, CheckboxGroup, Checkbox, Dropdown,DropdownTrigger, DropdownMenu, DropdownItem,Card,CardBody,Image, Spinner, } from "@nextui-org/react";
...
export default function AdminSignUp() {
  ...
  const [formData, setFormData] = useState({
    ...
    gender: "",
    designation: "",
    course: [] as string[],   // Ensure this is typed as an array of strings
  ...
  const handleCourseChange = (selectedCourses: string[]) => {
    setFormData((prevState) => ({
      ...prevState,
      course: selectedCourses,  // Update course correctly
    }));
  };
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    ...
    try{
        ...
        const response = await axios.post('http://localhost:5000/api/auth/admin/signup', data, {
          headers: {
